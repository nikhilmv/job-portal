...
export const myProfile = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    try {
        const user = req.user;
        if (!user) {
...
export const getUserProfile = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    try {
...
export const updateUserProfile = async (req: authenticationRequest, res: Response, next: NextFunction) => {
...
export const updateProfilePic = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    ...
    const response = await axios.post(`${process.env.UPLOAD_SERVICE}/api/utils/upload`, formData,
        {
...
export const updateResume = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    const user = req.user;
...
export const addSkillToUser = async (req: authenticationRequest, res: Response, next: NextFunction) => {
...
export const deleteSkillFromUser = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    const client = await pool.connect();
...
export const applyForJob = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    const client = await pool.connect();
    ...
    const job = await pool.query(`SELECT is_active FROM jobs WHERE job_id = $1`, [job_id]);
...
export const getAllaplications = async (req: authenticationRequest, res: Response, next: NextFunction) => {
    const client = await pool.connect();
