...
import { job_service, userAppData } from "@/context/AppContext";
...
const company = () => {
  ...
  async function fetchCompanies() {
    console.log("fetchCompanies started");
    try {
      ...
      console.log(
        "fetchCompanies success:",
        data.companies ? data.companies.length : "No companies data",
      );
      ...
      console.log("fetchCompanies finally: setting companyLoading to false");
