...
import { auth_service, userAppData } from "@/context/AppContext";
...
function RegisterPage() {
  ...
  const { isAuth, setUser, loading, setIsAuth } = userAppData();
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2">Join job portal</h1>
